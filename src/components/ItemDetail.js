            ...
            <div className="container-fluid px-5">
                ...
                <div className="item-detail-container">
                    <div className="image-container">
                        <img src={product.imgUrl} alt={product.title} className={'image-product'}/>
                    </div>
                    <div className="description-container">
                        ...
                        <Fragment className="contador">
                            <h5 className="cantSelect">Cantidad seleccionada: {contadorDetail}</h5>
                            <Link className="btn btn-danger m-3" to={pathCart}>Terminar mi compra</Link>
                        </Fragment>
                        }

                    </div>
                </div>
                <button className={'btn btn-success m-5'} onClick={() => history.goBack()}>
                    Atras
                </button>
                <Link className="btn btn-success m-5" to={pathDefault}>Inicio</Link>
            </div>
        );
    } else {
        return (
